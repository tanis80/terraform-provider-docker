...
$DOCKER_REGISTRY_ADDRESS="127.0.0.1:15000"

$DOCKER_REGISTRY_USER="testuser"
$DOCKER_REGISTRY_PASS="testpwd"
$DOCKER_PRIVATE_IMAGE="127.0.0.1:15000/tftest-service:v1"
$TF_ACC=1
...
& $PSScriptRoot'\testing\setup_private_registry.ps1'
